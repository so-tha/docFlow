"""Rotas de Documentos - Upload, Histórico, Comparação e Aprovação"""
...
@login_required
def upload():
    """Formulário de upload: Cria novo documento ou adiciona nova versão"""
    if request.method == 'POST':
        ...
        try:
            if upload_type == 'new':
                ...
                version, comparison, is_duplicate = DocumentService.process_uploaded_file(
                    file=file,
...
def view_version(version_id):
    """Exibe detalhes de uma versão específica, comparando com a anterior se houver"""
...
def view_document(document_id):
    """Exibe o histórico de todas as versões de um documento"""
